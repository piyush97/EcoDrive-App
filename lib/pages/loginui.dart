...
class _Loginui extends State<Loginui> {
  ...
  go_otp() async {
    ...
    await widget.auth.verifyPhone(phone).then((val){
      Navigator.of(context).push(new MaterialPageRoute(builder: (context)=> OtpPage(auth: widget.auth,onSignedIn: widget.onSignedIn,phoneno: phone,)));
    });
          ...
          children: <Widget>[Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Image.asset('assets/icon/icon.png',height: 200.0,width:200.0,),
                ),
